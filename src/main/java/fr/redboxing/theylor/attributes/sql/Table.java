...
import fr.redboxing.theylor.attributes.sql.column.Column;
...
public class Table {
    ...
    public void set(String key, String column, Identifier data) {
        SQLHandler.saveString(tableName, key, column, data.toString());
    }
    ...
    public Identifier get(String key, String column, Identifier defaultValue) {
        return new Identifier(SQLHandler.loadString(tableName, key, column, defaultValue.toString()));
    }
}
